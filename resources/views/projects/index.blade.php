                    ...
                    <div class="mt-2">
                        @forelse ($projects as $project)
                            <a href="{{route('tasks.index', ['project_id' => $project->id])}}">
                                <div class="hover:text-blue-500 cursor-pointer shadow-lg p-4 border dark:border-gray-700 mt-3 bg-slate-100 dark:bg-gray-900 rounded-lg text-gray-900 dark:text-gray-100">
